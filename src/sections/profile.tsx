    ...
    <section id="perfil" className="bg-emerald-50 py-16 px-6 mt-20">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-12">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          {/* FORMAÇÃO */}
          <div className="mt-10">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-4">Formação Acadêmica</h3>

            <ul className="space-y-6 text-gray-700 dark:text-gray-300 text-base">
              <li>
